    ...
    if (f1.isDirectory())
     {
       ...
       for(int i=0;i<s.length;i++)
        {
           File f2=new File("C:\\Users\\ami\\Desktop\\ansar\\java\\packages"+"\\"+s[i]);
           if (f2.isDirectory())
       ...
       System.out.println("C:\\Users\\ami\\Desktop\\am\\java\\packages"+" is not a directory");
     ...
     for(int i=0;i<filelist.length;i++)
      {
        File f2=new File("C:\\Users\\ami\\Desktop\\am\\java\\packages"+"//"+filelist[i]);
