...
class TestFile
{
	...
	{
		File f1=new File("F\\JAVA\\labcycle\\prgm");
		if(f1.isDirectory())
		{
			...
			{
				File f2=new File("F\\JAVA\\labcycle\\prgm"+"//"+s[i]);
				if(f2.isDirectory())
				{
	   ...
	   {
		   System.out.println("F\\JAVA\\labcycle\\prgm" + " is not a directory");
	   }
...
boolean f=false;
	...
	{
		File f2=new File("DF\\JAVA\\labcycle\\prgm"+"//"+filelist[i]);
